...
public class GetTriangleAreaTests {
    ...
    @Test
    @Title("Send get request to obtain triangle's area")
    public void successGetTriangleArea(){

        qaQuizSteps.sendPostRequest(withSeparatorJson);
        String id = qaQuizSteps.getId();
        qaQuizSteps.getStatusCode(200);
        qaQuizSteps.sendGetTriangleAreaRequest(id);
        qaQuizSteps.getStatusCode(200);
        qaQuizSteps.calculateTriangleArea(a,b,c);
        qaQuizSteps.sendDeleteRequest(id);
    }

    @Test
    @Title("Send get request to obtain custom triangle area")
    public void errorGetCustomTriangleArea(){
